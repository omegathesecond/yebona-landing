...
import { ShieldCheck, LayoutDashboard, UserSearch, Users, Scale, Wallet, Flag, ListChecks, ScrollText, LogOut, KeyRound, Loader2 } from 'lucide-react'
      ...
      >
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Provider verification · disputes · payouts · reports</p>
          </div>
        </div>
